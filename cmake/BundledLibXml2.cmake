...
function(use_bundled_libxml2 SOURCE_DIR BINARY_DIR)
    ...
    if (WIN32)
        ...
        ExternalProject_Add(
                ...
                CONFIGURE_COMMAND ""
                PATCH_COMMAND ./configure --enable-shared=no --enable-static=yes --with-iconv=no --with-zlib=no --with-lzma=no --with-python=no --prefix=${BINARY_DIR}/thirdparty/libxml2-install
                STEP_TARGETS build
    ...
    set(LIBXML2_INCLUDE_DIR "${BINARY_DIR}/thirdparty/libxml2-install/include" CACHE STRING "" FORCE)
