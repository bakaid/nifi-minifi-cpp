...
//        ->supportsExpressionLanguage(true)->isRequired(false)->build());
//
//core::Relationship PutSFTP::Success("success", "All FlowFiles that are received are routed to success");
//
//void PutSFTP::initialize() {
//  logger_->log_trace("Initializing GetSFTP");
//
