...
function(use_bundled_liblzma SOURCE_DIR BINARY_DIR)
    ...
    if (WIN32)
        ...
        set(CONFIGURE_COMMAND ./configure "CFLAGS=${CMAKE_C_FLAGS}" "CXXFLAGS=${CMAKE_CXX_FLAGS}" --disable-xz --disable-xzdec --disable-lzmadec --disable-lzmainfo --disable-lzma-links --disable-scripts --disable-doc --enable-shared=no "--prefix=${LIBLZMA_BIN_DIR}")
        if(PORTABLE)
