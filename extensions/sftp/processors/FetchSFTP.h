...
class FetchSFTP : public SFTPProcessorBase {
 public:
  ...
  static constexpr char const* ATTRIBUTE_FILENAME = "filename";
  static constexpr char const* ATTRIBUTE_PATH = "path";
  ...
  class WriteCallback : public OutputStreamCallback {
   public:
    ...
    bool commit();
    utils::SFTPError getError();

   private:
    std::shared_ptr<logging::Logger> logger_;
    bool read_succeeded_;
    utils::SFTPError error_;
