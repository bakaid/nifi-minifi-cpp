...
function(use_bundled_civetweb SOURCE_DIR BINARY_DIR)
    ...
    if (OPENSSL_FOUND)
        set_target_properties(c-library PROPERTIES INTERFACE_LINK_LIBRARIES "${OPENSSL_LIBRARIES}")
    endif(OPENSSL_FOUND)
    set_target_properties(civetweb-cpp PROPERTIES INTERFACE_LINK_LIBRARIES "civetweb")
