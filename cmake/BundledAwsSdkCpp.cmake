...
function(use_bundled_libaws SOURCE_DIR BINARY_DIR)
    ...
    list(APPEND AWS_C_COMMON_CMAKE_ARGS "-DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH_PASSTHROUGH}")
    list(APPEND AWS_C_COMMON_CMAKE_ARGS ${PASSTHROUGH_VARIABLES})
    ...
    string(REPLACE ";" "%" CMAKE_MODULE_PATH_PASSTHROUGH "${CMAKE_MODULE_PATH}")
    list(APPEND AWS_CHECKSUM_CMAKE_ARGS "-DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH_PASSTHROUGH}")
    list(APPEND AWS_CHECKSUM_CMAKE_ARGS ${PASSTHROUGH_VARIABLES})
    ...
    string(REPLACE ";" "%" CMAKE_MODULE_PATH_PASSTHROUGH "${CMAKE_MODULE_PATH}")
    list(APPEND AWS_C_EVENT_STREAM_CMAKE_ARGS "-DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH_PASSTHROUGH}")
    list(APPEND AWS_C_EVENT_STREAM_CMAKE_ARGS ${PASSTHROUGH_VARIABLES})
    ...
    string(REPLACE ";" "%" CMAKE_MODULE_PATH_PASSTHROUGH "${CMAKE_MODULE_PATH}")
    list(APPEND AWS_SDK_CPP_CMAKE_ARGS "-DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH_PASSTHROUGH}")
    list(APPEND AWS_SDK_CPP_CMAKE_ARGS ${PASSTHROUGH_VARIABLES})
